...
describe("OKCSwapAdapter", function () {
    async function deploy() {
        ...
        let MockOKCSwapRouter = await MockOKCSwapRouterFactory.deploy(WNativeToken);

        let SwapHelperFactory = await ethers.getContractFactory("OKCSwapAdapter");
        let SwapHelper = await SwapHelperFactory.deploy(MockOKCSwapRouter.address, owner.address);
