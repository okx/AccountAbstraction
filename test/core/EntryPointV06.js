...
describe("EntryPointV06", function () {
  async function deploy() {
    ...
    let EntryPointSimulations = await ethers.getContractFactory(
      "contracts/helper/EntryPointSimulations-0.6.sol:EntryPointSimulations"
    );
    let simulationContract = await EntryPointSimulations.deploy(
      EntryPoint.address
    );
