...
import "../simulations/interfaces/IEntryPointSimulations.sol";
import "../simulations/core/EntryPoint.sol";
 ...
 */
contract MockEntryPointSimulations is EntryPoint, IEntryPointSimulations {
    ...
    function _emitUserOperationRevertReason(
        UserOpInfo memory opInfo,
        bytes memory result
    ) internal override {
        userOpErrMsg = result;
